<template>
  <div class="products-container">
    ...
    <div v-if="showImage" class="image-container mt-3">
      <img :src="currentImage" alt="Imagen del producto" class="img-fluid" />
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      showImage: false, // Estado para mostrar u ocultar la imagen
  ...
  methods: {
    ...
    toggleImage(product) {
      this.currentImage = product.image || "https://via.placeholder.com/400"; // Usar una URL por defecto si no hay imagen
